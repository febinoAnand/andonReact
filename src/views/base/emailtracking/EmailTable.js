                  ...
                  {filteredEmails.length === 0 ? (
                    ...
                    filteredEmails.map((email, index) => (
                      ...
                      >
                        ...
                        <CTableDataCell style={{ maxWidth: '120px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                          {email.date}
                        </CTableDataCell>
      ...
      >
        ...
        <CModalBody>
          {selectedEmail ? (
            <>
              <CRow className="mb-3">
                <CFormLabel htmlFor="fromEmail" className="col-sm-3 col-form-label">
              ...
              <CRow className="mb-3">
                <CFormLabel htmlFor="toEmail" className="col-sm-3 col-form-label">
              ...
              <CRow className="mb-3">
                <CFormLabel htmlFor="subject" className="col-sm-3 col-form-label">
              ...
              <CRow className="mb-3">
                <CFormLabel htmlFor="datetime" className="col-sm-3 col-form-label">
                ...
                <CCol sm={9}>
                  <CFormInput
                    type="text"
                    id="datetime"
                    value={`${selectedEmail.date} - ${selectedEmail.time}`}
                    readOnly
                    plainText
                  />
                </CCol>
              ...
              <CRow className="mb-3">
                <CFormLabel htmlFor="message" className="col-sm-3 col-form-label">
                  <strong>Message:</strong>
                </CFormLabel>
                <CCol sm={9}>
                  <CFormInput as="textarea" id="message" value={selectedEmail.message} readOnly rows="15" />
                </CCol>
              </CRow>
            </>
          ) : (
